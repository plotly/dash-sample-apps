                        ...
                        html.Div(
                            [
                                html.Div(
                                    [
                                        html.H6(
                                            "Felecia Conroy", style={"color": "#003399"}
                                        ),
                                        html.P("453-264-8591"),
                                        html.P("ilq@w.ipq"),
                                    ],
                                ...
                                html.Div(
                                    [
                                        html.H6(
                                            "Abraham Lemke", style={"color": "#003399"}
                                        ),
                                        html.P("248-865-2687"),
                                        html.P("mc@a.kur"),
                                    ],
                ...
                html.Div(
                    [
                        ...
                        html.Div(
                            [
                                html.P(
                                    lorem.paragraph() * 3, style={"margin-top": "40px"}
                                ),
                                html.P(
                        ...
                        html.Div(
                            [
                                html.P(
                                    lorem.paragraph() * 2, style={"margin-top": "40px"}
                                ),
                                html.P(
                ...
                html.Div(
                    [
                        ...
                        html.Div(
                            ...
                            style={"margin-left": "250px", "margin-bottom": "15px"},
                        ),
                    ],
                    className="subpage",
                )
                            ...
                            [
                                ...
                                html.Div(
                                    [
                                        ...
                                        html.Div(
                                            html.Img(
                                                src=app.get_asset_url("DBkxRT2.png"),
                                                style={
                                                    "height": "180px",
                                                    "float": "right",
                                                },
                            ...
                            [
                                html.Div(
                                    [
                                        ...
                                        html.P(
                                            lorem.paragraph(), style={"float": "left"}
                                        ),
                                        html.P(
                                            lorem.paragraph(), style={"float": "left"}
                                        ),
        ...
        html.Div(
            [
                html.Div(
                            ...
                            [
                                html.Div(
                                    [
                                        ...
                                        html.Img(
                                            src=app.get_asset_url("wX5mQYn.png"),
                    ...
                    style={"display": "flex", "flex-wrop": "wrap"},
                    className="subpage",
                )
            ],
            className="page",
        ...
        html.Div(
            [
               ...
               sed litora amet quam, massa purus condimentum",
                                ...
                                html.P(
                                    lorem.paragraph(),
                                    style={"margin-top": "10px", "color": color_1},
                                ),
                                html.P(lorem.paragraph(), style={"margin-top": "10px"}),
                            ],
                            className="eleven columns",
