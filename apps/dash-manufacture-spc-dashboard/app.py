...
def show_current_specs(n_clicks, dd_select, store_data):
    if n_clicks > 0:
        ...
        return dash_table.DataTable(
            ...
            style_cell={'backgroundColor': '#2d3038', 'color': 'darkgray', 'border': 'darkgray'},
    ...
    return generate_metric_row(
        ...
        },
        {
            ...
            'children':
                daq.GraduatedBar(
                    id=ooc_graph_id,
                    color={"ranges": {"#91dfd2": [0, 3], "#f4d44d ": [3, 7], "#f45060": [7, 15]}},
...
def update_piechart(interval, stored_data):
    if interval == 0:
        return {'data': [], 'layout': {'font': {'color': 'white'},
                                       'paper_bgcolor': '#1d202d',
                                       'plot_bgcolor': '#1d202d'}}
