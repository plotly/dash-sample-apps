...
def plotly_wordcloud(df):
    ...
    frequency_figure_data = {
        ...
        "layout": {"title": "Top 25 most frequent words", "height": "550"},
    }
...
top_banks_plot = [
    dcc.Loading(
        id="loading-banks-hist", children=[dcc.Graph(id="bank-sample")], type="default"
    )
]
frequency_word_plot = [
    dcc.Loading(
        id="loading-frequency",
...
body = dbc.Container(
    [
        dbc.Row(
            [
                dbc.Col(left_column, md=5, align="center", style={"marginTop": 30}),
...
def set_n(n_value, time_values):
    ...
    return {
        "data": [{"x": values_sample, "y": counts_sample, "type": "bar", "name": ""}],
        "layout": {"title": "Top 20 offenders"},
    }
