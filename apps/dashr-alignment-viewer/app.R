      ...
      htmlDiv(
        ...
        children = list(
          htmlA(
            ...
            children = list(
              htmlImg(
                src = "assets/plotly-dash-bio-logo.png"
              )
            ),
            href = "/Portal"
          ),
          htmlH2("Dash Alignment Viewer"),
          htmlA(
            id = "gh-link",
            children = list("View on GitHub"),
            href = "https://github.com/plotly/dash-bio/blob/master/tests/dashbio_demos/app_alignment_viewer.py",
      ...
      htmlDiv(
        ...
        children=list(
          dccLoading(
            ...
            children=dashbioAlignmentChart(
              id='alignment-chart',
              height=725,
              data=dataset3,
            )
                        ...
                        htmlDiv(list(
                          ...
                          htmlDiv(
                            ...
                            children = list(
                              ...
                              htmlDiv(className = 'app-controls-desc',
                          ...
                          htmlDiv(
                            ...
                            children = list(
                              ...
                              dccSlider(
                                ...
                                min = 8,
                                max = 12,
                                marks = as.list(setNames(c(paste((8:12)
                                )), ((
                                  8:12
                                )))),
                                step = 1,
  ...
  event_data_select <- function(data) {
    ...
    if(length(names(data))==0){
      ...
      q<-lapply(
        ...
        function(x){
          htmlDiv(
            paste(x,":",gsub("<br>", " ", gsub("<b>","", gsub("</b>","",data[[x]], fixed = TRUE)))
            )
          )
        }
      )
