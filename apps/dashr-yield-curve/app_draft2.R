...
TEXTS <- l.(
  l.(dccMarkdown(className='six columns', children=" #### Yield curve 101 "), htmlBr(),
     dccMarkdown(className='six columns', children=" The yield curve shows how much it costs the federal government to borrow
                 ...
                 tomorrow and many years from now. ", style=l.('text-align'='center'))), 
            
      l.(dccMarkdown(className='six columns', children= "#### Where we stand"),htmlBr(),
            dccMarkdown(className='six columns', children="On Wednesday, both short-term and long-term rates were lower than they have
    ...
    mediocre growth in the years ahead.", style=l.('text-align'='center'))), 
            l.(dccMarkdown(className='six columns', children=' #### Deep in the valley'),htmlBr(),
            dccMarkdown(className='six columns', children='In response to the last recession, the Federal Reserve has kept short-term
    ...
    June.', style=l.('text-align'='center'))), 
            l.(dccMarkdown(className='six columns', children=' #### Last time, a puzzle'),htmlBr(),
            dccMarkdown(className='six columns', children='The last time the Fed started raising rates was in 2004. From 2004 to 2006,
    ...
    foreign demand.', style=l.('text-align'='center'))), 
            l.(dccMarkdown(className='six columns', children='#### Long-term rates are low now, too'), htmlBr(),
            dccMarkdown(className='six columns', children= 'Foreign buyers have helped keep long-term rates low recently, too - as have
    ...
    Some economists refer to the economic pessimism as "the new normal."', style=l.('text-align'='center'))), 
            l.(dccMarkdown(className='six columns', children=' #### Long-term rates are low now, too'), htmlBr(),
               dccMarkdown(className='six columns', children= 'Here is the same chart viewed from above.', style=l.('text-align'='center')))
  )
