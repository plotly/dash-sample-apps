...
def description_card():
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                id="intro",
                children="Explore clinic patient volume by time of the day, waiting time at clinic, and care score. Click on heatmap to visualize patient experience at different time points.",
            ),
        ],
    )
