...
def normalize_events(df):
    ...
    df = df[['SET PIECE', 'PASS', 'BALL LOST', 'RECOVERY', 'CHALLENGE', 'SHOT', 'INTERCEPTION', 'CROSS', 'DEEP BALL', 'FREE KICK']]
    df.columns=['Set Plays', 'Passes', 'Balls Lost', 'Recoveries', 'Challenges', 'Shots', 'Interceptions', 'Crosses', 'Long Balls', 'Free Kicks']
...
def team_radar_builder(filename, team_id):
    ...
    team_row_value = team_row_value[['SET PIECE', 'PASS', 'BALL LOST', 'RECOVERY', 'CHALLENGE', 'SHOT', 'INTERCEPTION', 'CROSS', 'DEEP BALL', 'FREE KICK']]
