...
supplyDemand <- fread("supplyDemand.csv")
actualSeasonal <- fread("actualSeasonal.csv")
industrailProd <- fread("industrailProd.csv")
globalMarket <- fread("globalMarket.csv")
oecdCommersial <- fread("oecdCommersial.csv")
wtiPrices <- fread("/wtiPrices.csv")
...
energyShare <- fread("energyShare.csv")
