...
app$layout(htmlDiv(list(
  ...
  htmlDiv(list(
    htmlDiv(list(
      ...
      htmlDiv(list(
        htmlDiv(list(
          htmlH6("Viverra, imperdiet, praesent pellentesque",
                 style = list("color" = "#003399")),
          htmlP(LipP(1, F))
        ), style = list(
            "border-left" = "5px",
        ...
        htmlDiv(list(
          htmlH6("Facilisis mauris parturient, eget vitae",
                 style = list("color" = "#003399")),
          htmlP(LipP(1, F))
        ), style = list(
            "border-left" = "5px",
        ...
        htmlDiv(list(
          htmlH6("A suspendisse mauris aliquam tincidunt hac",
                 style = list("color" = "#003399")),
          htmlP(LipP(1, F))
        ), style = list(
            "border-left" = "5px",
        ...
        htmlDiv(list(
          htmlH6("A elementum lorem dolor aliquam nisi diam",
                 style = list("color" = "#003399")),
          htmlP(LipP(1, F))
        ), style = list(
            "border-left" = "5px",
  ...
  htmlDiv(list(
    htmlDiv(list(
      ...
      htmlDiv(list(
        htmlDiv(list(
          htmlH6("Mauris feugiat quis lobortis nisl sed",
      ...
      style = list("margin-left" = "250px", "margin-bottom" = "15px"))
    ), className = "subpage")
  ), className = "page"),
  ...
  htmlDiv(list(
    htmlDiv(list(
      ...
      ), className = "thirdPage row", style = list("padding-top" = "20px",
                                                   "margin-left" = "30px")),
      htmlDiv(list(
      ...
      style = list("position" = "relative", "top" = "20px", "margin-left" = "30px")),
      htmlDiv(list(
        htmlDiv(list(
          dccGraph(
            figure = list(
      ...
      ), style = list("padding-top" = "20px", "margin-left" = "30px"))
    ), className = "subpage")
  ), className = "page"),
  ...
  htmlDiv(list(
    htmlDiv(list(
      ...
      style = list("position" = "relative", "margin-top" = "40px")),
      htmlDiv(list(
        htmlStrong("Vehicula elementum congue penatibus massa, eu sed",
                   className = "eleven columns",
                   style = list("color" = color_1)),
        htmlDiv(
      ...
      htmlDiv(list(
        htmlStrong("At velit pharetra ac fusce sit dictum pellentesque",
                   className = "eleven columns",
                   style = list("color" = color_1)),
        htmlDiv(list(
          dccGraph(
  ...
  htmlDiv(list(
    htmlDiv(list(
      htmlDiv(list(
        ...
        htmlDiv(list(
          htmlDiv(list(
            htmlStrong("Vehicula elementum congue penatibus massa, eu sed sed dolor",
                       style = list("color" = color_1)),
            htmlDiv(list(
          ...
          htmlDiv(list(
            htmlStrong("At velit pharetra ac fusce sit dictum pellentesque, dictumst",
                       style = list("color" = color_1)),
            htmlDiv(
              dccGraph(
                figure = list(
        ...
        ), className = "eight columns", style = list(
            "padding" = "30px",
            "margin-bottom" = "30px",
            "position" = "relative",
            "margin-top" = "10px",
  ...
  htmlDiv(list(
    htmlDiv(list(
      htmlDiv(list(
        htmlDiv(list(
          htmlH6(paste("Aliquet ut mauris nostra habitant egestas, ",
          "massa vulputate. Magnis nullam leo eget ullamcorper lacus congue laoreet ex sed",
          sep = ""),
                 style = list("color" = color_1, "margin-top" = "40px")),
  ...
  htmlDiv(list(
    htmlDiv(list(
      htmlDiv(list(
        htmlDiv(list(
          htmlP(paste("Aenean felis et libero nullam pretium quis est in sit. ",
                      "Commodo nec ante aenean a. Commodo at facilisis vestibulum ",
                      "cursus elementum nascetur et, placerat class aliquam convallis ",
                      "porttitor accumsan. Ultricies sed laoreet eleifend maximus venenatis",
                      sep = ""),
                style = list("color" = color_1)),
          htmlStrong("Congue nisl iaculis interdum cubilia maximus"),
          htmlImg(src = "assets/wX5mQYn.png",
                  className = "exhibit eleven columns",
                  style = list("height" = "250", "margin-top" = "20px"))
        ), style = list("float" = "left")),
        htmlDiv(list(
          htmlP(paste("Id nulla sollicitudin taciti ac tempus amet ligula accumsan. ",
                      "Elementum, nullam dui ligula ut. Adipiscing sed ultricies ut ",
                      "vitae augue etiam nostra nibh.", sep = ""),
                style = list(color = color_1)),
  ...
  htmlDiv(list(
    htmlDiv(list(
      htmlDiv(list(
        htmlDiv(list(
          htmlStrong(paste("Nulla diam conubia nec lacus urna in ligula ",
                           "nec ut egestas sed. Diam inceptos nec venenatis", sep = ""),
                     style = list("color" = color_1)),
          htmlP("Nulla diam conubia nec lacus urna in ligula nec ut egestas sed",
                style = list("font-size" = "11")),
          htmlDiv(list(
            dccGraph(
              figure = list(
        ...
        htmlDiv(list(
          htmlStrong(paste("Risus amet quam, eget, lacus, orci, dui ",
                           "facilisis dolor sodales arcu facilisi consectetur", sep = ""),
                     style = list("color" = color_1)),
          htmlP("Diam, maximus ultricies neque adipiscing tellus eros proin",
                style = list("font-size" = "11")),
          htmlDiv(list(
            dccGraph(
              figure = list(
      ...
      htmlDiv(list(
        htmlDiv(list(
          htmlStrong("Porttitor felis eget nibh quam duis et at a massa varius.",
                     style = list("color" = color_1)),
          htmlP("Risus amet quam, eget, lacus, orci, dui facilisis ",
                style = list("font-size" = "11")),
          htmlDiv(list(
            dccGraph(
              figure = list(
        ...
        htmlDiv(list(
          htmlStrong("Arcu aenean litora quam dignissim penatibus sem ultrices",
                     style = list("color" = color_1)),
          htmlP("Aenean ipsum nostra magna ut sagittis venenatis",
                style = list("font-size" = "11")),
          htmlDiv(list(
            dccGraph(
              figure = list(
  ...
  htmlDiv(list(
    htmlDiv(list(
      htmlDiv(list(
        htmlH6(paste("In tempor mauris non, maximus non odio. Lacus mi arcu, ",
                     "ut parturient ac sed curae sed litora amet quam, ",
                     "massa purus condimentum", sep = ""),
  ...
  htmlDiv(list(
    htmlDiv(list(
      htmlDiv(list(
        htmlH6(paste("Erat cras porta inceptos nibh sociis justo. ",
                     "Natoque mauris nunc etiam, dis quam, tempor ",
                     "consectetur ac Pulvinar nunc vitae dui elit hac ante, ",
                     "facilisi, primis nascetur. Non nostra torquent ipsum ac amet",
                     sep = ""),
               style = list("color" = color_1, "margin-top" = "40px")),
        htmlP(LipP(1, F), style = list("margin-top" = "30px")),
        htmlP(LipP(2, F), style = list("margin-top" = "30px")),
        htmlH6(paste("Ultrices phasellus dignissim, accumsan platea volutpat, ",
               "sapien mi enim. Pharetra ipsum netus in turpis, lorem tempus et. ",
               "Eget sed. Eu porta cum tempor convallis sed nostra, pellentesque eros.",
               sep = ""),
