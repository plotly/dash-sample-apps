  ...
  sectorAllocationPlotOrj$data[[1]]$marker$color <- "#119dff"
  sectorAllocationPlotOrj$layout$height <- 195
  sectorAllocationPlotOrj$layout$margin$b <- 58
  sectorAllocationPlotOrj$data[[1]]$x[2] <- "Asset-Back Securities"
  sectorAllocationPlotOrj$data[[1]]$x[3] <- "Residential Mortgages"
  sectorAllocationPlotOrj$data[[1]]$x[7] <- "Commercial Mortgages"


  currencyWeightPlotOrj <- fromJSON(file = "data/17555.json")
  currencyWeightPlotOrj$data[[1]]$marker$color <- "#119dff"
  currencyWeightPlotOrj$layout$height <- 195
  currencyWeightPlotOrj$layout$margin$t <- 0
