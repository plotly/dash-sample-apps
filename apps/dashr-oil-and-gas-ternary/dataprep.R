setwd('/USers/kevinphan/Desktop/PLOTLY APPS MADE/OG Ternary')

df = read.csv("Well_ID-Table_1.csv")
...
df_fm = read.csv("FmCodes-Table_1.csv")
...
write.csv(df,'test_compositionR.csv')
