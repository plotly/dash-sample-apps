...
app <- Dash$new(external_stylesheets = 'https://codepen.io/plotly/pen/YeqjLb.css')

app$layout(htmlDiv(children = list(
  htmlP(
    children = list('Click on the brain to add an annotation.
...
htmlDiv(list(dccRadioItems(
  options=list(
    list('label' = 'Cortical Thickness', 'value' = 'human'),
    list('label' = 'Mouse Brain', 'value' = 'mouse'),
